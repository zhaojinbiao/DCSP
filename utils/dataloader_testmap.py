...
# 主要是为了测试方便，主要在not train的情况下添加了name的输出
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.train:
            ...
            image_data, box, foggy_image, name = self.get_random_data(self.annotations[index],self.input_shape)
        ...
        if self.train:
            ...
            return image_data, box, foggy_image, name
    ...
    def get_random_data(self, annotation_line, input_shape):
        ...
        if not self.train:
            ...
            return clean_image_data, box, foggy_image_data, img_name
...
def yolo_dataset_collate(batch):
    ...
    foggy_images = []
    names = []
    for img, box, foggy_imag, name in batch:
        images.append(img)
        bboxes.append(box)
    ...
    return images, bboxes, foggy_images, names