...
def parse_opt(known=False):
    ...
    parser.add_argument('--val_fog_annotation_path', type=str, default='datasets/RTTStest/2007_train.txt', help='雾图验证集标注')
    parser.add_argument('--val_clean_annotation_path', type=str, default='datasets/RTTStest/2007_train.txt', help='干净图验证集标注')
    ...
    parser.add_argument('--test_out_path', type=str, default='datasets/RTTStest/test_out', help='推理map的路径')
...
#--------------------------------------------------------------------tiao zheng model mood----------------------------------------------------------------------------------
    ...
    for iteration, batch in enumerate(gen_test):
            ...
            if opt.detection:
                    ...
                    root = ET.parse(os.path.join("datasets/RTTStest/VOC2007", "Annotations/"+image_id+".xml")).getroot()
